...
export const normalizeGraphQLError = (
  err: ApolloGraphQLError | any
...
const resolveErrorCode = (
  ...
  const extCode = normalizedErrors.find((e) => typeof e.code === 'string')
...
export const assertGraphQLResponse = <TData = any>(
  ...
  options?: {
    ...
    friendlyMessageMap?: Partial<Record<ErrorCode, string>>;
  }
): TData => {
