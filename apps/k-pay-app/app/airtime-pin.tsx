...
export default function AirtimePinScreen() {
  ...
  const handleContinue = async () => {
    ...
    try {
      // Simulate PIN verification and airtime purchase
      await new Promise((resolve) => setTimeout(resolve, 2000));

      // For demo purposes, accept any 4-digit PIN
      // In a real app, this would verify PIN and process airtime purchase

      // Navigate to airtime success screen
      setIsNavigating(true);
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Please enter your 4-digit PIN to confirm your airtime purchase
            </Typography>
          </View>
