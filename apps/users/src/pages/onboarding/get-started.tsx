...
import { ArrowRight, ProfileCircle, Shop } from 'iconsax-reactjs';
...
function GetStarted() {
  ...
  return (
    ...
    >
      ...
      <Button
        variant={selectedAccount ? 'default' : 'muted'}
        className="w-full mt-4 !rounded-lg !py-6"
        disabled={!selectedAccount}
        onClick={() => navigate({ to: `/onboarding/login?user=${selectedAccount}` })}
      >
        Continue
      </Button>
