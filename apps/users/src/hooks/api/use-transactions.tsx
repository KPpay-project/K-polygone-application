...
export const useTransactions = (variables: GetTransactionsVariables) => {
  return useQuery<GetTransactionsResult, GetTransactionsVariables>(GET_TRANSACTIONS, { variables });
};

export const useWalletTransactionById = (transactionId: string) => {
  return useQuery<GetWalletTransactionByIdResult, GetWalletTransactionByIdVariables>(GET_WALLET_TRANSACTION_BY_ID, {
