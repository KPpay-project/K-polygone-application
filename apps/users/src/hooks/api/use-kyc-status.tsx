...
import { getSimpleKycStatus, type KycStatus, type SimpleKycApplication } from '../../utils/kyc/simple';
...
export const useKycStatus = (): UseKycStatusReturn => {
  ...
  const kycStatus = useMemo(() => {
    const kycApplications = data?.me?.kycApplications as SimpleKycApplication[] | undefined;
  ...
  return {
    ...
    loading,
    error,
    kycApplications: data?.me?.kycApplications as SimpleKycApplication[] | undefined
  };
};
