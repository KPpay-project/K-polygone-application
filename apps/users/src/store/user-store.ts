...
export const useFullUserDetails = () => useUserStore((state) => state.userAccount);
...
export const useMerchant = () => useUserStore((state) => state.userAccount?.merchant);
export const useAdmin = () => useUserStore((state) => state.userAccount?.admin);
export const useUserRole = () => useUserStore((state) => state.userAccount?.role);
export const useUserStatus = () => useUserStore((state) => state.userAccount?.status);
