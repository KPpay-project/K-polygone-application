    ...
    >
      ...
      <div className="relative h-full flex flex-col">
        ...
        <div className="flex-1 p-6 flex flex-col justify-between items-center text-center">
          ...
          <Button variant="disabled_outline" className="mt-2" asChild>
            <a href={currentAd.path}>{currentAd.actionLabel}</a>
          </Button>
        </div>
      </div>
        ...
        {ads.map((_, index) => (
          <button
            ...
            className={cn(
              ...
              index === currentIndex ? 'bg-primary w-6' : 'bg-gray-300 w-1.5 hover:bg-gray-400',
            )}
